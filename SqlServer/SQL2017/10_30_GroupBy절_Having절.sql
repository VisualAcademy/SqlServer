/*
	Group By 절과 Having 절
		Group By : 특정 컬럼(필드)를 그룹화(묶음) : 묶는조건
		Having : Group By로 묶인 항목(집계함수)에 대한 조건 처리
*/
...
FROM Orders
GROUP BY [상품명]; -- 묶는조건 : 상품명, 집계함수 : 총판매평균
...
--[5] 퀴즈: 각 주문별 상품 판매량이 5이상이고, 
--    그룹별 총 판매평균이 7이상인것만 [상품명]으로 오름차순 정렬해서 출력하시오.
